...
if KEYWORD_SET(help) then begin
   print, 'pro NOSE_HOOVER, demo=demo, dt=dt, t_stop=t_stop, $'
...
NOSE_HOOVER, demo=0, method=method, verbose=verbose, invQ1=invQ1, invQ2=invQ2, $
  out=out0, dt=dt_max, t_stop=t_stop
NOSE_HOOVER, demo=0, method=method, verbose=verbose, invQ1=invQ1, invQ2=invQ2, $
  out=out1, dt=dt_max/2., t_stop=t_stop
NOSE_HOOVER, demo=0, method=method, verbose=verbose, invQ1=invQ1, invQ2=invQ2, $
  out=out2, dt=dt_max/4., t_stop=t_stop
;
DEVICE, /decomposed
WINDOW, 0
;
...
;
t0=SYSTIME(1)
NOSE_HOOVER, /demo, method=0, out=out0
t_0=SYSTIME(1)-t0
print, 'Time for Internal method :', t_0
;
; Classical external (IDL/GDL syntax coded) RK4 method
;
t1=SYSTIME(1)
NOSE_HOOVER, /demo, method=1, out=out1
t_1=SYSTIME(1)-t1
print, 'Time for External method :', t_1
;
; External (IDL/GDL syntax coded) RK4 method via RK4_pro
;
t2=SYSTIME(1)
NOSE_HOOVER, /demo, method=2, out=out2
t_2=SYSTIME(1)-t2
print, 'Time for External 2 method :', t_2
;
; Displaying results
;
