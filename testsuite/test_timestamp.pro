...
; ---------------------------------
;
;WARNING: The compiler must allow a NULL value.
;-------  When a wrong timestamp value is stored in a variable  
;-------  after a correct timestamp value, the value of the variable keeps
;-------  the last correct timestamp value. 
;
;
;
;
