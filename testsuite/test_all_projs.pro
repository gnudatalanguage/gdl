...
pro test_all_projs, from=from, to=to, lon=lon, lat=lat, rot=rot, image=image, halt=halt
  ...
  for iproj=from,to do begin
     ...
     map_set,/relaxed,/advance,lat,lon,rot,title=pjn[iproj],name=pjn[iproj],lat_1=12,lat_2=56,lat_ts=33,height=3,e_cont={cont:1,fill:1,color:'33e469'x,hires:0},/hor,e_hor={nvert:200,fill:1,color:'F06A10'x},e_grid={box_axes:0,color:'1260E2'x,glinethick:1,glinestyle:0},/iso,sat_tilt=33,OEA_SHAPEM=1,OEA_SHAPEN=1,SOM_LANDSAT_NUMBER=2, SOM_LANDSAT_PATH=22, ZONE=28
