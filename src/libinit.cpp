...
//Please note that NOWAIT and HIDE are WINDOWS-Reserved Keywords.
  ...
  const string helpKey[]={"ALL_KEYS","BRIEF","FULL","CALLS","DEVICE","FUNCTIONS","HELP","INFO",
			  ...
			  "RECALL_COMMANDS","ROUTINES","SOURCE_FILES","STRUCTURES","SYSTEM_VARIABLES","TRACEBACK", "COMMON", KLISTEND};
  ...
  const string deviceKey[]=
    {
      ...
      "GET_WRITE_MASK", "COPY","GET_FONTNAMES","SET_FONT","GET_CURRENT_FONT","GET_FONTNUM",  KLISTEND
    };
  const string deviceWarnKey[] = {"FONT", "HELVETICA", 
