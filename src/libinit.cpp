...
void LibInit()
{
  ...
  const string helpKey[]={"ALL_KEYS","BRIEF","CALLS","DEVICE","FUNCTIONS","HELP","INFO",
			  ...
			  "RECALL_COMMANDS","ROUTINES","SOURCE_FILES","STRUCTURES","SYSTEM_VARIABLES", KLISTEND};
  const string helpWarnKey[]={"BREAKPOINTS","DLM","FILES","FULL","HEAP_VARIABLES","LEVEL","MESSAGES",
			      "OBJECTS","SHARED_MEMORY","TRACEBACK", KLISTEND};
  ...
  const string deviceKey[]=
    {
      ...
      "GET_WINDOW_POSITION","GET_PIXEL_DEPTH","GET_VISUAL_DEPTH","GET_VISUAL_NAME","GET_WRITE_MASK", KLISTEND
    };
  const string deviceWarnKey[] = {"GET_CURRENT_FONT","GET_FONTNAMES","GET_FONTNUM","SET_FONT", "HELVETICA", 
