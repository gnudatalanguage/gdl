...
void GDLLexer::initLiterals()
{
	...
	literals["case"] = 85;
	literals["repeat"] = 71;
	literals["endforeach"] = 94;
	literals["ne"] = 110;
	literals["end"] = 90;
	literals["le"] = 107;
	literals["then"] = 117;
	literals["begin"] = 84;
	literals["endswitch"] = 97;
	literals["and"] = 83;
	literals["endrep"] = 96;
	literals["not"] = 111;
	literals["on_ioerror"] = 113;
	literals["mod"] = 109;
	literals["do"] = 88;
	literals["function"] = 101;
	literals["endfor"] = 93;
	literals["gt"] = 104;
	literals["inherits"] = 106;
	literals["of"] = 112;
	literals["or"] = 114;
	literals["if"] = 105;
	literals["pro"] = 115;
	literals["xor"] = 119;
	literals["compile_opt"] = 87;
	literals["ge"] = 102;
	literals["goto"] = 103;
	literals["for"] = 30;
	literals["eq"] = 99;
	literals["forward_function"] = 100;
	literals["foreach"] = 32;
	literals["endelse"] = 92;
	literals["until"] = 118;
	literals["else"] = 89;
	literals["lt"] = 108;
	literals["endwhile"] = 98;
	literals["switch"] = 116;
	literals["common"] = 86;
	literals["endif"] = 95;
	literals["while"] = 81;
