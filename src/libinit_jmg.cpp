...
//BASE  
  ...
  "BASE_ALIGN_CENTER","BASE_ALIGN_LEFT","BASE_ALIGN_RIGHT","SPACE",KLISTEND};
  const string widget_baseWarnKey[] = {"ALIGN_BOTTOM","ALIGN_TOP",
  "BASE_ALIGN_BOTTOM","BASE_ALIGN_TOP",
  "CONTEXT_MENU",  "TLB_FRAME_ATTR",  "TOOLBAR","BITMAP", KLISTEND};
  new DLibFunRetNew(lib::widget_base,string("WIDGET_BASE"),1,widget_baseKey,widget_baseWarnKey);
//BUTTON
  const string widget_buttonKey[] = {WIDGET_COMMON_KEYWORDS,"MENU","VALUE","HELP","SEPARATOR","INPUT_FOCUS","BITMAP","TOOLTIP",KLISTEND};
  const string widget_buttonWarnKey[] ={"ACCELERATOR","CHECKED_MENU","DYNAMIC_RESIZE",
  "TRACKING_EVENTS","X_BITMAP_EXTRA","NO_RELEASE",KLISTEND};
...
//CONTROL
  ...
  "UPDATE","FORMAT","EDIT_CELL",  "TABLE_XSIZE","TABLE_YSIZE","SEND_EVENT",
   KLISTEND};
  const string widget_WarnControlKey[] ={"DEFAULT_FONT",
  "XOFFSET","YOFFSET","DYNAMIC_RESIZE","PUSHBUTTON_EVENTS",
  "TABLE_BLANK",
...
//INFO
  ...
  "TABLE_DISJOINT_SELECTION","TABLE_SELECT","COLUMN_WIDTHS","ROW_HEIGHTS","USE_TABLE_SELECT","SYSTEM_COLORS",KLISTEND};
...
//  "TABLE_EDITABLE","TABLE_EDIT_CELL","TABLE_FONT","TABLE_FOREGROUND_COLOR","TABLE_VIEW","TAB_CURRENT",
...
//  "TREE_INDEX","TREE_ROOT","TREE_SELECT","UNITS","UPDATE","USE_TABLE_SELECT","VISIBLE",
    KLISTEND};
