...
//BUTTON
  ...
  const string widget_buttonWarnKey[] ={"ACCELERATOR","CHECKED_MENU","DYNAMIC_RESIZE","ALIGN_BOTTOM","ALIGN_TOP",
...
//INFO
  ...
  "EVENT_FUNC","EVENT_PRO","N_CHILDREN","ALL_CHILDREN",KLISTEND};
...
//  "TLB_SIZE_EVENTS","TOOLTIP","TRACKING_EVENTS","TREE_BITMAP","TREE_DRAG_SELECT","UNITS","UPDATE","USE_TABLE_SELECT","VISIBLE",
  "TAB_MODE",KLISTEND};
