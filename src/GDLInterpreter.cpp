...
const unsigned long GDLInterpreter::_tokenSet_0_data_[] = { 3232760224UL, 1879508031UL, 71413760UL, 37769216UL, 12UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long GDLInterpreter::_tokenSet_1_data_[] = { 738853792UL, 206045888UL, 3538956UL, 0UL, 12UL, 0UL, 1048832UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
